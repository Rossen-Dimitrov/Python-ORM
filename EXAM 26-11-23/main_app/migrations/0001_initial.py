# Generated by Django 4.2.4 on 2023-11-26 07:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_year', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MinValueValidator(2005)])),
        ...
        migrations.AddField(
            model_name='article',
            name='authors',
            field=models.ManyToManyField(related_name='authors', to='main_app.author'),
        ),
    ]
