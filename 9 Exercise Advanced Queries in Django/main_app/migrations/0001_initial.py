    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release_year', models.PositiveIntegerField(validators=[main_app.validators.release_year_validator])),
                ('rating', models.DecimalField(decimal_places=1, max_digits=2, validators=[main_app.validators.rating_validator])),
            ],
        ),
        migrations.CreateModel(
            name='Project',
